...
Sorted Array of n 
Now array is rotated at some unknown pivot
eg [1,3,5,7,8] After rotating at index 3
    [7,8,1,3,5]
Find index of given integer K in array (-1 if not present)

Solution 
find pivot then
if arr[pivot]<= target <= arr[n-1]
    apply bin search on lower line
else
    apply bin search on upper line
...
/*
Approch 2 : find out (hint in pdf)
*/